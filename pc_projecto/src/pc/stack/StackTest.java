...
public abstract class StackTest {
  ...
  public void test4() {
    ...
    assertOneOf (
        array(a,    b,     c,   d ),
        //pop(a) > push(1) > push(2) > pop(d) > push(3) > pop(b) > pop(c)
        array(null, 3, 1, 2),
        // push(1) >pop(a) > push(2) > pop(d) > push(3) > pop(b) > pop(c)
        array(1, 3, null, 2),
        // push(1) > push(2) > pop(a) > pop(d) > push(3) > pop(b) > pop(c)
        array(2, 3,null ,1 ),
        // push(1) > push(2) > pop(d) > pop(a) > push(3) > pop(b) > pop(c)
        //array(1, 3, null , 2),

        //pop(a) > push(1) > push(2) > pop(d)  > pop(b) > push(3) > pop(c)
        array(null, 1, 3, 2),
        // push(1) >pop(a) > push(2) > pop(d) > pop(b) > push(3) > pop(c)
        array(1, null, 3, 2),
        // push(1) > push(2) > pop(a) > pop(d) > pop(b) > push(3) > pop(c)
        array(2, null, 3, 1),
        // push(1) > push(2) > pop(d) > pop(a) > pop(b) > push(3) > pop(c)
        //array(1, null, 3, 2),

        //pop(a) > push(1) > push(2) > pop(d) > pop(b) > pop(c) > push(3)
        array(null, 1, null, 2),
        // push(1) >pop(a) > push(2) > pop(d) > pop(b) > pop(c) > push(3)
        array(1, null, null, 2),
        // push(1) > push(2) > pop(a) > pop(d) > pop(b) > pop(c) > push(3)
        array(2, null, null, 1)
        // push(1) > push(2) > pop(d) > pop(a) > pop(b) > pop(c) > push(3)
        //array(1, null, null, 2)
